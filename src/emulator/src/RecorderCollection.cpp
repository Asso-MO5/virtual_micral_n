...
ValueRecorder& RecorderCollection::create_and_get_value_recorder(const std::string& signal_name,
                                                                 double time_frame_in_s,
                                                                 double projected_event_frequency,
                                                                 int8_t bus_width)
{
    ...
    auto new_value_recorder = std::make_shared<ValueRecorder>(number_of_events, bus_width);
